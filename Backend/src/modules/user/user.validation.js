...
const updateProfileValidation = [
  ...
  body('emergencyContactPhone').optional().matches(/^(0|\+84)[3-9][0-9]{8}$/).withMessage('SĐT liên hệ khẩn cấp không hợp lệ'),
];
...
const createUserValidation = [
  ...
  body('role').isIn(Object.values(ROLES)).withMessage('Role không hợp lệ'),
  body('gender').optional().isIn(Object.values(GENDER)).withMessage('Giới tính không hợp lệ'),
];
